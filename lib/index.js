...
const pageTreeview = module.exports = {
    ...
    hooks: {
    	'page:before': function (page) {
            ...
            var renderContent = pageTreeview.initHeaders(page.content, defaultOption.style, defaultOption.minHeaderCount, defaultOption.minHeaderDeep);
            ...
            var insertTreeview = (renderContent === '') ? '' : '<div class="treeview__container">' + copyRight + new Remarkable().render(renderContent) + '</div>';
    ...
    test: function (configs, contents) {
        ...
        var insertTreeview = '<div class="treeview__container">' + copyRight + new Remarkable().render(pageTreeview.initHeaders(contents, defaultOption.style, defaultOption.minHeaderCount, defaultOption.minHeaderDeep)) + '</div>';
     ...
     * @return {[type]}                [description]
     */
    initHeaders: function (content, style, minHeaderCount, minHeaderDeep) {
        var res = [];
        var minLevel = 6;
        var levelTab = [];
            ...
            if (headers[i] === null) {
                ...
                switch (style) {
                    case 'markdown':
                        ...
                        break;
                    case 'tag':
                        res.push('<a href="#' + href + '" class="level' + (tabLen + 1) + '">' + title + '</a>');
                        break;
                    default:
                        break;
                }
        ...
        console.log('headersLen: ' + (headers.length - nullCount) + ', minHeaderCount: ' + (parseInt(minHeaderCount) === NaN ? 1 : parseInt(minHeaderCount)));
        console.log('maxDeep: ' + maxDeep + ', minHeaderDeep: ' + (parseInt(minHeaderDeep) === NaN ? 1 : parseInt(minHeaderDeep)));

        if (headers.length - nullCount < (parseInt(minHeaderCount) === NaN ? 1 : parseInt(minHeaderCount)) && maxDeep < (parseInt(minHeaderDeep) === NaN ? 1 : parseInt(minHeaderDeep))) {
            return '';
        }
